-- Criação das tabelas base do sistema: produtos, matérias-primas e o vínculo de composição.
-- Define chaves primárias, estrangeiras e restrições de integridade (unique e check).
